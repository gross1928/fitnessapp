...
{
  "detected_food": "Название блюда с большой буквы",
  "confidence": "Уровень уверенности от 0 до 1 (например, 0.85)",
  "estimated_calories": "ОБЩЕЕ число калорий для всей порции",
  "estimated_nutrition": {
  ...
  "ingredients": [
    { "name": "Название ингредиента", "weight_grams": "Вес в граммах" }
  ],
  "serving_suggestions": ["совет 1", "совет 2"],
  "health_notes": ["заметка о здоровье 1", "заметка о здоровье 2"]
}

Важно: confidence должен быть числом от 0 до 1, все значения nutrition должны быть числами, а не строками.
`
