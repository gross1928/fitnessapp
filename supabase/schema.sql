...
CREATE INDEX IF NOT EXISTS idx_meal_entries_user_id_date ON meal_entries(user_id, DATE(created_at));
CREATE INDEX IF NOT EXISTS idx_water_entries_user_id_date ON water_entries(user_id, DATE(created_at));
CREATE INDEX IF NOT EXISTS idx_weight_entries_user_id_date ON weight_entries(user_id, DATE(created_at));
CREATE INDEX IF NOT EXISTS idx_health_analyses_user_id ON health_analyses(user_id);
CREATE INDEX IF NOT EXISTS idx_chat_messages_user_id_date ON chat_messages(user_id, DATE(created_at));
